...
const customcolor1 = Color(0xFF12486B);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF12486B),
  customcolor1: Color(0xFF006497),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFCCE5FF),
  onCustomcolor1Container: Color(0xFF001D31),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF12486B),
  customcolor1: Color(0xFF92CCFF),
  onCustomcolor1: Color(0xFF003351),
  customcolor1Container: Color(0xFF004B73),
