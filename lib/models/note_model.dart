...
class Note {
  ...
  // Map'ten Note'a dönüşüm
  factory Note.fromMap(Map<dynamic, dynamic> map,String key) {
    return Note(
      id: key,
      title: map['title'],
      content: map['content'],
      modifiedTime: map["modifiedTime"], //DateTime.parse(map['modifiedTime']),
    );
  }

  // Note'dan Map'e dönüşüm
